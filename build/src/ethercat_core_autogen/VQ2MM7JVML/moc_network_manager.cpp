...
#include <memory>
#include "../../../../include/qt_ui/network/network_manager.h"
...
QT_MOC_LITERAL(1, 15, 16), // "onNetworkChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 5), // "index"
QT_MOC_LITERAL(4, 39, 16), // "onRefreshNetwork"
QT_MOC_LITERAL(5, 56, 16) // "onConfirmNetwork"

    },
    "NetworkManager\0onNetworkChanged\0\0index\0"
    "onRefreshNetwork\0onConfirmNetwork"
};
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onNetworkChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->onRefreshNetwork(); break;
        case 2: _t->onConfirmNetwork(); break;
        default: ;
        }
    }
}
